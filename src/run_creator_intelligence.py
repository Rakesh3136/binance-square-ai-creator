...
SCRIPTS = ['audience_intelligence.py','market_timing.py','experiment_engine.py','visual_intelligence.py','thesis_ledger.py','creator_evolution.py','market_intelligence_6.py','capital_flow_intelligence.py']
...
def main():
    ...
    report = {'generated_at': datetime.now(timezone.utc).isoformat(), 'status': 'OK' if not failures else 'DEGRADED', 'completed': results, 'failures': failures, 'brain_deferred_to_production_stage': True, 'rule': 'Creator Brain runs after preflight and engagement selection.', 'market_intelligence_version': '6.2', 'capital_flow_intelligence': 'enabled'}
