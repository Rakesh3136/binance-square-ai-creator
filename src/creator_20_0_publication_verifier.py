...
def main():
    ...
    if has_verified_id and ids_match:
    ...
    elif latest and status == "PUBLISH_BLOCKED_DUPLICATE":
    ...
    elif latest and status == "PUBLISH_SKIPPED_WTE_INELIGIBLE":
        ...
        proof = "Binance content/add returned HTTP 504 after submission; the post may exist but no canonical post id was returned, so it is not treated as verified"
    ...
    result = {
        "version": "20.4-skip-aware-live-proof",
        "checked_at": now,
