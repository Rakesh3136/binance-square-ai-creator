...
def main():
    ...
    # Preflight is the authoritative opportunity for this production cycle. Brain
    # may refine the angle, but must not silently replace the selected asset.
