...
PRE=ROOT/'data/live/editorial_preflight.json'; ENGAGEMENT=ROOT/'data/live/engagement_strategy.json'; MARKET=ROOT/'data/live/market_snapshot.json'; CADENCE=ROOT/'data/live/autonomous_cadence_6.json'; OUT=ROOT/'data/live/authoritative_opportunity.json'
...
def main():
    pre=load(PRE); eng=load(ENGAGEMENT); market=load(MARKET); cadence=load(CADENCE)
